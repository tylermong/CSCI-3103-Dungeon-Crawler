...
public class Spider extends Monster
{
    ...
    {
        super((player1.getMaxHP() / 2) + (player1.getMaxHP() * randStats.nextInt(-5,6) / 100),
                (player1.getAttack() / 2) + (player1.getAttack() * randStats.nextInt(-5, 6) / 100),
                (player1.getDefense() / 3) + (player1.getDefense() * randStats.nextInt(-5, 6) / 100),
                (player1.getSpeed() * 2) + (player1.getSpeed() * randStats.nextInt(-5, 6) / 100),
